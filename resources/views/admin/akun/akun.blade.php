            ...
            <div class="grid grid-cols-10 h-screen">
                <div class=" col-span-2 bg-light-secondary flex flex-col justify-between relative">
                    <div class="">
                        ...
                        <a href="public\html\sertifikasi.html" class="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-light-button hover:rounded-full">
                            <div class="">
                ...
                <div class="col-span-8 bg-light-secondary relative"> 
                    <div class=" flex flex-col justify-between bg-light-primary absolute z-50 bottom-0 w-[90%] h-[85%] p-20 rounded-tr-[3rem] rounded-tl-[3rem]">
                            ...
                            <div class="text-center">
                                <a href="./admin-ubah akun.html" class="cursor-pointer rounded-full bg-light-button px-10 py-4 text-sm font-bold text-white hover:opacity-80">Ubah Profil                               
                                </a>
                            </div>     
                    </div>
                </div>               
